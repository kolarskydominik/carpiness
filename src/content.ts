    ...
    areas: [
      {
        ...
        items: [
          ...
          {
            iconSrc: 'icons/dialogflow.svg',
            label: 'Dialogflow',
          },
          {
            iconSrc: 'icons/mediapipe.svg',
            label: 'Mediapipe',
          },
          {
            iconSrc: 'icons/mediapipe.svg',
      ...
      },
      {
        ...
        items: [
          ...
          {
            iconSrc: 'icons/mapnik.svg',
            label: 'Mapnik',
          },
          {
            iconSrc: 'icons/livekit.svg',
            label: 'Livekit',
          },
        ],
      },
      {
        ...
        items: [
          ...
          {
            iconSrc: 'icons/vuedotjs.svg',
            label: 'Vue.JS',
          },
          {
            iconSrc: 'icons/awsamplify.svg',
            label: 'Amplify AWS',
          },
          {
